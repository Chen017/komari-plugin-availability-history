...
console.log('[BUILD] Packaging into availability-history.zip...');
...
const zipPath = path.join(ROOT_DIR, 'availability-history.zip');
...
if (fs.existsSync(desktopDir)) {
  const desktopZipPath = path.join(desktopDir, 'availability-history.zip');
  try {
